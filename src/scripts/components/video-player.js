class VideoPlayerFinal {
  constructor() {
    ...
    this.videoList = [
      {
        src: "public/media/video/player/video1.mp4",
        title: "Te observo",
        duration: "10",
        size: "5 MB",
      },
      {
        src: "public/media/video/player/video2.mp4",
        title: "Loney Loney",
        duration: "16",
        size: "12 MB",
      },
      {
        src: "public/media/video/player/video3.mp4",
        title: "Avion de guerra",
        duration: "13",
        size: "7 MB",
      },
      {
        src: "public/media/video/player/video4.mp4",
        title: "Formula 1",
        duration: "39",
        size: "26 MB",
      },
      {
        src: "public/media/video/player/video5.mp4",
        title: "War Thunder",
        duration: "14",
        size: "5 MB",
      },
      {
        src: "public/media/video/player/video6.mp4",
        title: "Marcas de autos edit",
        duration: "17",
        size: "11 MB",
      },
      {
        src: "public/media/video/player/video7.mp4",
        title: "NEED FOR SPEED MOST WANTED",
        duration: "22",
        size: "24 MB",
      },
      {
        src: "public/media/video/player/video8.mp4",
        title: "CARS",
        duration: "21",
        size: "23 MB",
      },
      {
        src: "public/media/video/player/video9.mp4",
        title: "MUAJAJAJAJA",
        duration: "28",
        size: "30 MB",
      },
      {
        src: "public/media/video/player/video10.mp4",
        title: "I'LL WATCH YOU HATE",
        duration: "1:02",
        size: "59 MB",
      },
      {
        src: "public/media/video/player/video11.mp4",
        title: "Spider Man edit",
        duration: "16",
        size: "13 MB",
      },
      {
        src: "public/media/video/player/video12.mp4",
        title: "Arabia Saudi edit",
        duration: "16",
        size: "13 MB",
      },
      {
        src: "public/media/video/player/video13.mp4",
        title: "Dexter Morgan edit",
        duration: "19",
        size: "15 MB",
      },
      {
        src: "public/media/video/player/video14.mp4",
        title: "Mita edit",
        duration: "14",
        size: "11 MB",
      },
      {
        src: "public/media/video/player/video15.mp4",
