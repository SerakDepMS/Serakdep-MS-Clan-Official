document.addEventListener("DOMContentLoaded", function () {
  ...
  const scenesData = [
    ...
    { chapter: "XVII",label: "El Marco Legal",           text: "En febrero de 2026, la página web se adaptó a la legalidad vigente (LOPD, Cookies, Aviso Legal y DMCA). El clan protege rigurosamente la privacidad y los datos de menores de 14 años con consentimiento paterno." },
    ...
    { chapter: "XXIII",label: "Evolución Digital",      text: "Desde la beta 0.5 estática, el portal evolucionó a la v1.0, v2.0 con bases npoint.io y FAQ, la v3.7 ultra-optimizada con actualización automática cada 12 segundos, y la v6 actual de este viaje cinematográfico." },
