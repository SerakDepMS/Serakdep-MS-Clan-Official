document.addEventListener("DOMContentLoaded", function () {
  ...
  const scenesData = [
    ...
    { chapter: "VIII",label: "Los Lazos Móviles",        text: "Para facilitar la comunicación diaria se estructuraron los grupos oficiales de WhatsApp: Principal, Actividades y Nuevos Ingresos." },
